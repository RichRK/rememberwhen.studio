...
<html lang="en">
	...
	<head>
		...
		<link rel="preload" href="../fonts/Spectral-Bold.woff2" as="font">
		...
		<section id="content">
			...
			<div class="portion">
				...
				<div class="segment">
					...
					<div class="entry" data-video-id="297873975">

						<i class="material-icons top-right">close</i>

						<div class="player">
							
							<div class="playButton">Play video<i class="material-icons">play_arrow</i></div>

						</div>

						<div class="metadata">
						
							<h2 class="couple">Elyse &amp; Gerry</h2>
							<h3 class="venue">Italian Cultural Centre</h3>

						</div>

					</div>

					<div class="entry" data-video-id="301414465">
						...
						<div class="metadata">
							...
							<h2 class="couple">Anj &amp; Trav</h2>
							<h3 class="venue">Eagle Harbour Yacht Club</h3>
